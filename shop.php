				...
				<div class="wrapper_top_shop">
					...
					<div class="product-sec1">
						...
						<?php
							...
							$result = mysqli_query($conn,"Select * from products where Category = 'Creature'");
 							...
 							<div class="product-shoe-info shoe">
 								<div class="men-pro-item">
 									<div class="men-thumb-item">
 										<img src="images/Pictures/Creatures/<?= $row['Picture'] ?>" alt="">
 										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<form action="single_creature.php" method="POST">
 												<button type="hidden" href="single_creature.php" name="hola" method="post" value="<?= $row['ID_Product'] ?>" class="link-product-add-cart">More info</a></button>
											</form>
											</div>
 										</div>
